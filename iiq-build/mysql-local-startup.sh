...
################
# This script starts up the mysqld server locally, within the same container as
# IIQ. This is directly taken from the Docker official build of mysql-server,
